    ...
    <div className={`${Style.checkoutSection} bg-black d-flex`}>
      <div className={`${Style.checkout} col-lg-7  col-12 p-5  border-r`} >
        ...
        <div className='p-3 mt-2'>
            ...
            <div>
                <input className='w-100 p-3 rounded-lg borderColor text-white' id="email" name="email" placeholder="Email or mobile phone number" type="text" inputmode="text" aria-labelledby="email-label" autocomplete="shipping email" autofocus="true" data-protected-input="true"  autocapitalize="off" />  
            </div>
        ...
        <div>
          <div className='p-3'>
              ...
              <div className=''>
                  ...
                  <select className='w-100 borderColor p-3 text-white rounded-lg' name="countryCode" id="Select16" required="" autocomplete="shipping country" >
          ...
          <div className='d-flex gap-2 justify-content-center p-3'>
            <div className=' w-100'>
              <input className='w-100 borderColor p-3 text-white rounded-lg' id="TextField43" name="firstName" placeholder="First name (optional)" type="text" aria-required="false" aria-labelledby="TextField43-label" autocomplete="shipping given-name" data-protected-input="true"  />
            </div>
            <div className='w-100'>
                <input className='w-100 borderColor text-white p-3 rounded-lg' id="TextField44" name="lastName" placeholder="Last name" required="" type="text" aria-required="true" aria-labelledby="TextField44-label" autocomplete="shipping family-name" data-protected-input="true"  />
            </div>
          </div>
