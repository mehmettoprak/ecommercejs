  ...
  return (
    <div className={`${Style.navBar} p-4 `}>
      <div  className='d-flex align-items-center w-100 e justify-content-between'>
            <button class="navbar-toggler borderColor rounded-lg d-block d-md-none"type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
          ...
          <div className="offcanvas d-flex flex-column flex-md-row  offcanvas-start   " tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel"> 
              <div className="offcanvas-header  ">
                <button className='borderColor rounded-lg ' type="button" data-bs-dismiss="offcanvas" aria-label="Close"  >
                  <div className={`${Style.addCart}  `}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="h-6 transition-all ease-in-out hover:scale-110 ">
        ...
        <div className='flex-item d-flex justify-content-end'>
          <button className='borderColor rounded-lg  ' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" >
            <div className={`${Style.addCart}  `}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" className="textWhite  ">
          ...
          <div className="offcanvas offcanvas-end bg-black borderColor text-white p-4" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            ...
            <div className="mt-20 d-flex w-100 flex-column align-items-center justify-content-center overflow-hidden">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="height-16">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"></path>
              </svg>
